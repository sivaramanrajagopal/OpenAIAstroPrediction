                ...
                <div style={styles.tabContent}>
                  ...
                  {activeTab === "lifepurpose" && (
                    <>
                      ...
                      {lifePurpose && formatLifePurpose(lifePurpose)}
                    </>
                  )}
                        ...
                        <div style={styles.spouseContainer}>
                          <div style={styles.spouseReportCard}>
                            <h4 style={styles.spouseReportTitle}>
                              💍 Spouse Analysis Summary
                            </h4>
                            <div style={styles.spouseReportContent}>
                              <div style={styles.spouseReportLine}>
                                <strong>Gender:</strong> {spouseAnalysis.gender}
                              </div>
                              <div style={styles.spouseReportLine}>
                                <strong>Ascendant:</strong> {spouseAnalysis.lagna}
                              </div>
                              <div style={styles.spouseReportLine}>
                                <strong>7th House Sign:</strong> {spouseAnalysis['7th_house_sign']}
                              </div>
                              <div style={styles.spouseReportLine}>
                                <strong>7th Lord:</strong> {spouseAnalysis['7th_lord']}
                              </div>
                              <div style={styles.spouseReportLine}>
                                <strong>Spouse Direction:</strong> {spouseAnalysis.spouse_direction}
                              </div>
                            </div>
                          </div>

                          {spouseAnalysis.aspects && (
                            <div style={styles.spouseAspectsCard}>
                              <h4 style={styles.spouseAspectsTitle}>
                                🌟 Planetary Aspects
                              </h4>
                              <div style={styles.spouseAspectsGrid}>
                                {Object.entries(spouseAnalysis.aspects).map(([planet, aspects]) => (
                                  <div key={planet} style={styles.spouseAspectItem}>
                                    <div style={styles.spousePlanetName}>
                                      <Star size={12} color="#e11d48" />
                                      {planet}
                                    </div>
                                    <div style={styles.spouseAspectDetail}>
