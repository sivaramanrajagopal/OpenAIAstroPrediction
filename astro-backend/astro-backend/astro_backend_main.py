...
def career(dob: str,
    ...
    try:
        ...
        data = analyze_career(dob, tob, lat, lon, tz_offset, gender)
        report = generate_career_report(data)
        return {"career_analysis": data, "report": report}
    except Exception as e:
...
def yogas(dob: str,
    ...
    try:
        ...
        data = detect_yogas(dob, tob, lat, lon, tz_offset)
        return data
    except Exception as e:
...
def life_purpose(dob: str,
    ...
    try:
        ...
        data = analyze_life_purpose(dob, tob, lat, lon, tz_offset)
        report = generate_purpose_report(data)
        return {"life_purpose_analysis": data, "report": report}
    except Exception as e:
...
def dasa_bhukti(dob: str,
    ...
    try:
        ...
        data = get_dasa_positions(dob, tob, lat, lon, tz_offset)
        table = generate_dasa_bhukti_table(data)
...
def spouse(dob: str,
    ...
    try:
        ...
        data = get_spouse_positions(dob, tob, lat, lon, tz_offset)
        aspects = get_spouse_aspects(data)
        analysis = analyze_marriage(data, aspects, gender)
        report = spouse_report(analysis)
        return {"spouse_analysis": data, "aspects": aspects, "analysis": analysis, "report": report}
    except Exception as e:
